...
class softRobotVisualizer():
    def __init__(self,obsEn = False) -> None:
        ...
        if self.obsEn:
            ...
            self.obs1 =  self.ax.scatter([], [], [],marker='o',lw=5)
            self.obs2 =  self.ax.scatter([], [], [],marker='o',lw=5)
            self.obs3 =  self.ax.scatter([], [], [],marker='o',lw=5)
            self.obs4 =  self.ax.scatter([], [], [],marker='o',lw=5)
    ...
    def update_graph(self,num):
        ...
        # self.title.set_text('3D Test, time={}'.format(num))
